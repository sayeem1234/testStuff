...
public class mobile_FFL {
    ...
    @DataProvider(name = "mobile_FFL")
    public Object[] readRSA_transactions_browser() throws IOException {
        BufferedReader brTest = new BufferedReader(new FileReader("/Users/Fayeem/Desktop/Transaction_IDS/Mobile/FrictionlessFlowIDS/frictionlessflowmobile.txt"));
    ...
    @Test(dataProvider = "mobile_FFL")
    public void frictionlessflow_mobile(String transactionID_endpoint){
    ...
    @Test(dataProvider = "mobile_FFL")
    public void DS_mobile_frictionlessFlow(String transactionID_endpoint){
