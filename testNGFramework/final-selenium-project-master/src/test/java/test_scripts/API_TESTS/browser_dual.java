...
public class browser_dual {


    String baseUrl = "https://qa-transaction-logging-backend.ct.msignia.com/api/v2/transactions/";


    @DataProvider(name = "readRSA_transactions_browser_qa8")
    public Object[] readRSA_transactions_browser_8() throws IOException {
        BufferedReader brTest = new BufferedReader(new FileReader("/Users/Fayeem/Desktop/Transaction_IDS/Browser_IDS/DUALBRANDED/q8browser_rsa.txt"));
    ...
    @DataProvider(name = "readEC_transactions_Browser_qa8")
    public Object[] readEC_transactions_Browser_8() throws IOException {
        BufferedReader brTest = new BufferedReader(new FileReader("/Users/Fayeem/Desktop/Transaction_IDS/Browser_IDS/DUALBRANDED/q8browser_ec.txt"));
        String paragraph = brTest.readLine();
        String[] List = paragraph.split("(?<=\\G....................................)");
        String[] arr = new String[List.length]; //secondArray
        for (int i = 0; i < List.length; i++) {
    ...
    @DataProvider(name = "readRSA_transactions_browser_qa16")
    public Object[] readRSA_transactions_browser_16() throws IOException {
        BufferedReader brTest = new BufferedReader(new FileReader("/Users/Fayeem/Desktop/Transaction_IDS/Browser_IDS/DUALBRANDED/q16browser_rsa.txt"));
        String paragraph = brTest.readLine();
        String[] List = paragraph.split("(?<=\\G....................................)");
        String[] arr = new String[List.length]; //secondArray
        for (int i = 0; i < List.length; i++) {
    ...
    @DataProvider(name = "readEC_transactions_Browser_qa16")
    public Object[] readEC_transactions_Browser_16() throws IOException {
        BufferedReader brTest = new BufferedReader(new FileReader("/Users/Fayeem/Desktop/Transaction_IDS/Browser_IDS/DUALBRANDED/q16browser_ec.txt"));
        String paragraph = brTest.readLine();
        String[] List = paragraph.split("(?<=\\G....................................)");
        String[] arr = new String[List.length]; //secondArray
        for (int i = 0; i < List.length; i++) {
    ...
    //qatestrsa
    @Test(dataProvider = "readRSA_transactions_browser_qa8")
    public void test_rsa_transaction_qa8(String transactionID_endpoint){
        int count = 0;
        int Count = 0;
    ...
    @Test(dataProvider = "readRSA_transactions_browser_qa16")
    public void test_rsa_transaction_qa16(String transactionID_endpoint){
        int count = 0;
        int Count = 0;
        String transStatusY = "transStatus\":\"Y";
    ...
    @Test(dataProvider = "readEC_transactions_Browser_qa8")
    public void test_ec_transaction_8(String transactionID_endpoint){
        int count = 0;
        int Count = 0;
        String transStatusY = "transStatus\":\"Y";
...
//        Assert.assertTrue(Count > 0);
    ...
    @Test(dataProvider = "readEC_transactions_Browser_qa16")
    public void test_ec_transaction_16(String transactionID_endpoint){
        int count = 0;
        int Count = 0;
        String transStatusY = "transStatus\":\"Y";
