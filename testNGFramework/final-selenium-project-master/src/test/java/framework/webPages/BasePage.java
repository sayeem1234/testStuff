...
/**
 * Created by ShadidulHossain
 */
public class BasePage {

	// This is the most common wait function used in selenium
	public  WebElement webAction(final By locator) { //include static
	...
	public void hoverOver(By locator) {
		Actions actions = new Actions(DriverWrapper3.getDriver());
		WebElement hoverOverSpot = DriverWrapper3.getDriver().findElement(locator);
